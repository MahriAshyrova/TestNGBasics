...
public class Homework2 extends CommonMethods{
	...
	public void loginAndVerify() {
		...
		sendText(driver.findElement(By.xpath("//input[contains(@id,'MainContent_username')]")), "Tester");
		sendText(driver.findElement(By.xpath("//input[contains(@id,'MainContent_password')]")), "test");
		click(driver.findElement(By.xpath("//input[contains(@id,'MainContent_login_button')]")));
